...
const Footer = () => {
  return (
    <footer className="bg-[#a89fb5] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          {/* Logo */}
          <div>
            <div className="bg-[#FFD700] px-4 py-2 inline-block rounded mb-4">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              />
              <Button className="bg-white text-purple-dark hover:bg-gold transition-colors">
                →
              </Button>
            </div>
            <div className="flex gap-4 mt-4">
              ...
              <a href="#youtube" className="hover:text-gold transition-colors">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
